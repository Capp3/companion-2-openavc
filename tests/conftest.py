...
FROZEN_REVIEW_AT = datetime(2026, 1, 1, 0, 0, 0, tzinfo=UTC)
...
@pytest.fixture(autouse=True)
def frozen_review_at(monkeypatch: pytest.MonkeyPatch) -> None:
    """Pin review sidecar timestamps across CLI integration tests."""
    import c2o.emit.review

    monkeypatch.setattr(c2o.emit.review, "_review_at_override", FROZEN_REVIEW_AT)
